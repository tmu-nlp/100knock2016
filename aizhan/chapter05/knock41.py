...
from knock40 import Morph, get_morph
...
class Chunk:
    ...
    def __str__(self):
        return 'id: {}, dst: {}, srcs: {}'.format(
            str(self.id), str(self.dst), ','.join(str(i) for i in self.srcs))
    ...
    for i, sentence in enumerate(get_cabocha()):
        ...
        for chunk in sentence:
            ...
            for morph in chunk.morphs:
                print('\t', morph)
                print(chunk.get_path_to_root(sentence))
        #break
